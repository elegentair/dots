...
The color themeing for waybar is provided in the colors.css file. All unused colors are removed, and the bar only uses four colors (text, background, and two varible colors). These colors are configured manually. I experimented with pywal16 and wallust, but found they only looked good with certain images.
